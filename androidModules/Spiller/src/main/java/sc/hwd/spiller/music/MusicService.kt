 ...
 * Copyright (c) 2024.
 *
 * lastModified: 2024/8/24 上午4:23
 * updated: 2024/8/24 上午4:23
 */

package sc.hwd.spiller.music
...
//            PlaybackStateCompat.ACTION_STOP or
    ...
    companion object {
        const val ACTION_PLAY = "sc.hwd.sillot.kmp.action.PLAY"
        const val ACTION_START = "sc.hwd.sillot.kmp.action.START"
        const val ACTION_PAUSE = "sc.hwd.sillot.kmp.action.PAUSE"
        const val ACTION_RESUME = "sc.hwd.sillot.kmp.action.RESUME"
        const val ACTION_NEXT = "sc.hwd.sillot.kmp.action.NEXT"
        const val ACTION_PREVIOUS = "sc.hwd.sillot.kmp.action.PREVIOUS"
        const val ACTION_SEEKTO = "sc.hwd.sillot.kmp.action.SEEKTO"
        const val ACTION_SkipPrevious = "sc.hwd.sillot.kmp.action.SkipPrevious"
        const val ACTION_SkipNext = "sc.hwd.sillot.kmp.action.SkipNext"
        const val ACTION_MEDIA_STATUS_CHANGED = "sc.hwd.sillot.kmp.action.MEDIA_STATUS_CHANGED"
        const val EXTRA_MEDIA_PLAYING = "sc.hwd.sillot.kmp.extra.MEDIA_PLAYING"
        const val EXTRA_MEDIA_CURRENT_POSITION = "sc.hwd.sillot.kmp.extra.MEDIA_CURRENT_POSITION"
        const val EXTRA_MEDIA_DURATION = "sc.hwd.sillot.kmp.extra.MEDIA_DURATION"
    }
    ...
    override fun onCreate() {
        ...
        createNotificationChannel(
            S_Notification.SILLOT_MUSIC_PLAYER_NOTIFICATION_CHANNEL_ID,
            S_Notification.SILLOT_MUSIC_PLAYER_NOTIFICATION_CHANEL_NAME
        )
                ...
                ACTION_PLAY -> {
                    ...
                    if (uri != null) {
                        try {
                            ...
                            startForeground(S_Notification.USB_AUDIO_EXCLUSIVE_notificationId, createAudioPlaybackNotification())
...
//                            mediaController.transportControls.play()
    ...
    private fun createAudioPlaybackNotification(): Notification  {
        val builder = NotificationCompat.Builder(this, S_Notification.SILLOT_MUSIC_PLAYER_NOTIFICATION_CHANNEL_ID)
