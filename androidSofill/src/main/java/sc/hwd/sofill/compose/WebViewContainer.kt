 ...
 * Copyright (c) 2024.
 *
 * lastModified: 2024/8/25 下午12:58
 * updated: 2024/8/25 下午12:58
 */

package sc.hwd.sofill.compose
...
import sc.hwd.sofill.Us.U_Uri.askIntentForSUS
import sc.hwd.sofill.Us.checkWebViewVer
import sc.hwd.sofill.Us.injectEruda
import sc.hwd.sofill.Us.injectVConsole
import sc.hwd.sofill.android.SillotApplication
import sc.hwd.sofill.android.webview.WebPoolsPro
import sc.hwd.sofill.android.webview.WebViewClientManager
import sc.hwd.sofill.android.webview.WebViewLayoutManager
import sc.hwd.sofill.compose.theme.activeColor
import sc.hwd.sofill.compose.theme.defaultColor
import sc.hwd.sofill.compose.theme.disabledColor
import sc.hwd.sofill.interfaces.app.MenuOption
import sc.hwd.sofill.interfaces.app.MenuOptionState
...
fun GoToOption(
    ...
    val SE = mmkv.value.getSavedValue(
 ...
 * @see sc.hwd.sofill.Us.U_Uri.openURLUseSB
 */
...
fun FullScreenWebView(
    ...
    val sliderState_webViewTextZoom =
        mmkv.value.getSavedValue("WebViewContainer@sliderState_webViewTextZoom", 100)
        ...
        thisWebView.value?.let {
            ...
            wcm.downloadListener = object: DownloadListener {
                override fun onDownloadStart(
                    ...
                    val switchState_使用系统自带下载器下载文件 = mmkv.value.getSavedValue(
        ...
        bottomBar = {
            ...
            Row(
                ...
                if (inSearchInWebpage.value) {
                    ...
                    IconButtonPro(
                        Icons.Filled.ArrowUpward, contentDescription = "向上翻页",
                        onDoubleTap = {
                    ...
                    IconButtonPro(
                        Icons.Filled.ArrowDownward, contentDescription = "向下翻页",
                        onDoubleTap = {
        ...
        if (progressFloat.value == 1f) {
            Button(
                ...
                onClick = {
                    ...
                    val fileUri: Uri =
                        FileProvider.getUriForFile(Lcc, SillotApplication.getInstance().BuildConfig_PROVIDER_AUTHORITIES, file)
                    // TODO: 有空再解决
//                    Intent(Lcc, MainPro::class.java).let {
//                        it.data = fileUri
//                        it.flags = Intent.FLAG_GRANT_PERSISTABLE_URI_PERMISSION
//                        it.action = Intent.ACTION_VIEW
//                        Lcc.startActivity(it)
//                    }
                }) {
                Text("打开文件")
            }
