 ...
 * Copyright (c) 2024.
 *
 * lastModified: 2024/8/30 上午6:36
 * updated: 2024/8/30 上午6:36
 */
...
object U_DEBUG {
    ...
    fun getDeviceInfoString(): String {
        ...
        if (LibraryConfig.versionName.isNotEmpty()) {
            sb.append("Apk: ").append(LibraryConfig.versionName).append(" (")
                .append(LibraryConfig.versionCode).append(")\n")
        }
        return sb.toString()
    }
    @JvmStatic
