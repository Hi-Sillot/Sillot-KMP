 ...
 * Copyright (c) 2024.
 *
 * lastModified: 2024/8/25 上午1:02
 * updated: 2024/8/25 上午1:02
 */
...
import sc.hwd.sofill.U.genSpannableColorfulString
import sc.hwd.sofill.U.isSystemDarkMode
...
object U_DialogX {
    private val TAG = "sc.hwd.sofill.U.DialogX"
    ...
    private fun Context.genCSCSDA(text: CharSequence): CharSequence {
        ...
        return if (isDarkMode) genSpannableColorfulString(text, S_Color.Int_LightWhite) else text
    }
    ...
    fun PopNoteShow(context: Context, vararg params: Any): PopNotification {
        ...
        if (isDarkMode)  builder.setBackgroundColor(S_Color.Int_DarkDeep)
