...
import sc.hwd.sofill.Ss.S_File
import sc.hwd.sofill.android.util.FileUtil
import java.io.File
...
object U_FileUtils {
     ...
     *
     * @param targetFolderPath 目标文件夹的路径，相对于应用的私有目录。使用绝对路径，例： /storage/emulated/0/Android/data/sc.hwd.sillot.kmp/files/sillot
