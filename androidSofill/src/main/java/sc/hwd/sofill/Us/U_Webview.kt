 ...
 * Copyright (c) 2024.
 *
 * lastModified: 2024/8/30 上午6:38
 * updated: 2024/8/30 上午6:38
 */
...
import sc.hwd.sofill.U.compareVersions
import sc.hwd.sofill.Us.U_Uri.openURLUseDefaultApp
...
fun Context.getWebViewVer(): String {
    ...
    val webViewPackageInfo = packageManager.getPackageInfo(S_Intent.GoogleWebview, 0)
    val webViewVer = webViewPackageInfo.versionName ?: ""
        ...
        PopNotification.show("系统 WebView 版本 $webViewVer 太低, 请升级至 $minVer+").noAutoDismiss().onPopNotificationClickListener =
            object : OnDialogButtonClickListener<PopNotification?> {
                override fun onClick(
                    ...
                    openURLUseDefaultApp(S_Uri.URL_Sillot_docs_uprade_webview)
                    return true
                }
            }
    }
 ...
 * @see [sc.hwd.sofill.android.webview.WebViewLayoutManager]
 */
