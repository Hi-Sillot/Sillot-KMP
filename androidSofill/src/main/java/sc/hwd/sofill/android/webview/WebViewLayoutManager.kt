 ...
 * Copyright (c) 2024.
 *
 * lastModified: 2024/8/24 上午3:51
 * updated: 2024/8/24 上午3:51
 */

package sc.hwd.sofill.android.webview
...
import sc.hwd.sofill.Us.adjustLayoutMarginForSystemBars
import sc.hwd.sofill.Us.displayMetrics
import sc.hwd.sofill.Us.getSystemBarInsets
import sc.hwd.sofill.Us.isInSpecialMode
import sc.hwd.sofill.Us.navigationBarHeight
import sc.hwd.sofill.Us.statusBarHeight
import sc.hwd.sofill.Us.visibleRect
import sc.hwd.sofill.base.Debuggable
...
class WebViewLayoutManager private constructor(
    ...
    /**
     * 覆盖清单中声明，默认值为 [WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN],
     * 可以动态设置，例如  [WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE] ，注意同步修改 [delayResetLayoutWhenImeShow]
     */
    @JvmField
    var softInputMode =
